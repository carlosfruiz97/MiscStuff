...
// ==============================================================================
/********************************************************************************/
/*Function: Play from folder                                         */
/*Parameter:-uint8_t folder                                                     */
/*Parameter:-uint8_t song number                           */
void playFromFolder(uint8_t folder, uint8_t song_number)
{
  uint16_t dat = 0;
  dat |= folder << 8;
  dat |= song_number;
  sendCommand(CMD_PLAY_FOLDER_FILE, dat);
}

/********************************************************************************/
/*Function: Set volume                                                          */
/*Parameter:-uint8_t volume from 0 to 30                                        */
...
void sendMP3Command(char c) {
  switch (c) {
    ...
    case '2':
      ...
      sendCommand(CMD_FOLDER_CYCLE, 0x0002);
      break;

    case '3':
      Serial.println("Play folder 3");
      sendCommand(CMD_FOLDER_CYCLE, 0x0003);
      break;

    case '4':
      Serial.println("Play folder 4");
      sendCommand(CMD_FOLDER_CYCLE, 0x0004);
      break;
